...
function renderProducts(data) {
  ...
  backButton.innerHTML = `<button class="btn bg-blue-500 text-white px-4 py-2 rounded mt-20 ml-7" onclick="xInnerHtmlAndCallback(fetchCategories)">Categories</button>`;
  data.forEach((item) => {
